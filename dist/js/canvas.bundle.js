...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.p + "52e4bbaa8bca0fd888a69da7af4c1114.png");
...
/* harmony import */ var _img_flag_png__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../img/flag.png */ "./src/img/flag.png");
...
var c = canvas.getContext("2d"); // function add_img() {
...
var flags = createImage(_img_flag_png__WEBPACK_IMPORTED_MODULE_8__["default"]);
...
var scrollOffset = 0; // start init / reset interface
...
function init() {
  ...
  platforms = [new Platform({
    ...
    x: platformImage.width * 7 + 1100,
    y: 470,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 9 + 1450,
    y: 470,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 9 + 1750,
    y: 380,
    image: flags
  })];
...
function animate() {
  ...
  player.update(); // animate loop player moving
  ...
  if (scrollOffset >= platformImage.width * 9 + 1400) {
    console.log("You win papam padaaam");

    if (confirm("you win !  press okay to restar")) {
      init();
    } else {
